...
@EnableJpaRepositories(
        ...
        basePackages = { "ciamb.demo.springaxondemo.core.api.repository.write"}
)
public class WriteAxonDemoDBConfig {
    ...
    public LocalContainerEntityManagerFactoryBean writeEntityManagerFactory(EntityManagerFactoryBuilder builder,
        ...
        return builder
                ...
                .packages("ciamb.demo.springaxondemo.core.api.repository.write")
                .build();
    }
